...
func NewVoIPServer(addr string, numLoop int, msgChannel chan PingMessage) (*VoIPServer, error) {
...
func (vs *VoIPServer) analyzeLoop(packetChannel chan PingMessage) {
